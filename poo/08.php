...
class Cabecera {
  private $titulo;
  private $subtitol;
  public function __construct($tit, $subt)
  {
    $this->titulo = $tit;
    $this->subtitol = $subt;
  }
  ...
  public function graficar()
  {
    ...
    if($this->subtitol != ""){
      echo '<h2 style="text-align:center">'.$this->subtitol.'</h1>';
    }
  }
}
...
class Pagina {
  ...
  private $cuerpo;
  private $pie;
  public function __construct($texto1, $subtit, $texto2)
  {
    $this->cabecera=new Cabecera($texto1, $subtit);
